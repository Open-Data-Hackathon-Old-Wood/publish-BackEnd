...
from .schemas import PostPinRequest, PostPinResponse
from .service import PinWriteService
from .repository import RepositoryError


router = APIRouter(prefix="/register/matsu",tags=["pins:matsu:write"],)
